...
namespace AdapterGenerator.Tests.Core.Generation.Adapters {
  [TestFixture]
  public class EnumGenerationContextTests {
    IEnumAdapterGenerationContextWithMethod _sut;
    private ITypeDeclarations _sources;
    private ITypeDeclarations _targets;
    private IEnumAdapterBlueprint _adapterBlueprint;
    ...
    public virtual void SetUp() {
      ...
      _sut = EnumAdapterGenerationContext.Create(_sources, _targets, _allAdapterBlueprints, _adapterBlueprint)
